...
public static class Constants
{
    ...
    public static char Write = 'W'; // W + MiddleDelimiter + Receiver + MiddleDelimiter + Message
    public static char Receive = 'R'; // R + MiddleDelimiter + Sender + MiddleDelimiter + Receiver + MiddleDelimiter + Message
