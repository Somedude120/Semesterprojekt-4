...
//Det eneste SaltedHash laver er at tilføje og transformere en string. Derfor god til kode.
...
namespace AsyncSocketHashing.Test.Unit.Unit_Test
{
    ...
    public class SaltTest
    {
        ...
        public void Passwords_Are_Unique_Salt()
        {
            ...
            bool notSame = _uut2.Verify(_uut1.Salt, _uut1.Hash, "1234");
            Assert.AreNotEqual(_uut2, true);
        }
