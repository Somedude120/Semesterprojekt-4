...
class Program
{
    ...
    {
        //Dictionary<TcpClient, string> list_clients =
    ...
    public static void sendToSpecific(string data, int clientID)
    {
        byte[] buffer = Encoding.ASCII.GetBytes(data + clientID + Environment.NewLine);
