...
public class SecureTcpServer : IDisposable
{
    ...
    public SecureTcpServer(int listenPort, X509Certificate serverCertificate,
        SecureConnectionResultsCallback callback) : this(listenPort, serverCertificate, callback, null)
    {

    }

    public SecureTcpServer(int listenPort, 
    ...
    void OnAcceptConnection(IAsyncResult result)
    {
        ...
        try
        {
            ...
            //bool leaveStreamOpen = true;  //keep the socket open when done. Can be used if you don't want TLS on all communication
